...
struct io61_file
{
    ...
    // if `locked>0`, ID of owning thread
    //std::condition_variable_any cv;
};
...
//identical to flush function but with no lock to avoid deadlock
int helper_flush(io61_file *f)
{
